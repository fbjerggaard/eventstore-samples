...
public class IndexNameMapper
{
    ...
    public static string ToIndexPrefix<TStream>()
    {
        return ToIndexPrefix(typeof(TStream));
    }

    public static string ToIndexPrefix(Type streamType)
    {
        return Instance.typeNameMap.GetOrAdd(streamType, _ =>
        {
    ...
    {
        return ToIndexName(typeof(TStream));
    }
